...
public class OWLAPIDemo {
	public static void main(String[] args) {
		...
		try {
			...
			reasoner.getInstances(dataFactory.getOWLClass(IRI.create(oldontologyIRI.get() + "#Evenement")),false)
					.forEach(System.out::println);



		    // Get the relevant classes stores in the loaded ontology
		    OWLClass FolkloreEtTradictionClass = dataFactory.getOWLClass(IRI.create(oldontologyIRI.get() + "#Folklore_et_tradictionClass"));

		    // Get object properties stored within the loaded ontology.
		    OWLObjectPropertyExpression hasSport = dataFactory.getOWLObjectProperty(IRI.create(oldontologyIRI + "#hasParticipant"));
        ...
        // pas encore modifier 
		    ...
		    OWLNamedIndividual sochi2014Individual= dataFactory.getOWLNamedIndividual(IRI.create(oldontologyIRI.get() + "#Sochi2014"));
		    OWLNamedIndividual biathlonIndividualIndividual = dataFactory.getOWLNamedIndividual(IRI.create(oldontologyIRI.get() + "#Biathlon_Individual"));
			...
			// Get instances from SportCompetition and its subclasses
			System.out.println("\nInstances of Evenement AFTER addition of "
