...
public class OWLAPIDemo {
	public static void main(String[] args) {
		String oldOntologyFilename = "/Users/julienhubar/Documents/Julien/SemanticData/SemanticData/TourismeInWallonia.owl";
		String newOntologyFilename = "/Users/julienhubar/Documents/Julien/SemanticData/SemanticData/TourismeInWalloniaUpdate.owl";
		...
		try {
			...
			/*
			 *
			 * ADD AN EVENT TO THE ONTOLOGY
			 *
			 */
			System.out.println("");
			System.out.println("================================================================");
			System.out.println("==============ADD AN EVENT TO THE ONTOLOGY =====================");
			System.out.println("================================================================");
			System.out.println("");

			// Get instances from SportCompetition and its subclasses
			System.out.println("\nInstances of Evenement BEFORE addition to the Ontology :\n");
			reasoner.getInstances(dataFactory.getOWLClass(IRI.create(oldontologyIRI.get() + "#Province")),false)
					.forEach(System.out::println);



		    // Get the relevant classes stores in the loaded ontology
		    OWLClass FolkloreEtTradictionClass = dataFactory.getOWLClass(IRI.create(oldontologyIRI.get() + "#Liege"));
        ...
        // Get object properties stored within the loaded ontology.
     		    OWLObjectPropertyExpression hasSport = dataFactory.getOWLObjectProperty(
     		    		IRI.create(oldontologyIRI + "#isHostOf"));

     		    // Get two property values stored within the loaded ontology.
     		    OWLNamedIndividual LiegeCity = dataFactory.getOWLNamedIndividual(
     		    		IRI.create(oldontologyIRI.get() + "#Liege"));
     		    OWLNamedIndividual marcket = dataFactory.getOWLNamedIndividual(
     		    		IRI.create(oldontologyIRI.get() + "#La_batte"));

     		    // Create the new individual : a market in Liege (porvince not city)
     		    String wholename = oldontologyIRI.get() + "#MarchéVerviers";
                 ...
                 OWLObjectPropertyAssertionAxiom biathlonCompetitionHasSport = dataFactory.getOWLObjectPropertyAssertionAxiom(
                 		hasSport, biathlonCompetition, marcket);
                 ...
                 OWLObjectPropertyAssertionAxiom biathlonCompetitionHasHost = dataFactory.getOWLObjectPropertyAssertionAxiom(
                 		ifHostOf, biathlonCompetition, sochi2014Individual);
